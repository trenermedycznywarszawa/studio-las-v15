...
- add a regression check that the admin module references the canonical export;
...
The two inline-script CSP errors visible in DevTools originate from Netlify-injected badge UI and are not the Studio Las OS module-start failure.
