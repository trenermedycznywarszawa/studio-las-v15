-- Narrow cleanup path for browser E2E on the canonical non-production staging.
-- This function is intentionally unusable for ordinary clients or arbitrary rows.
